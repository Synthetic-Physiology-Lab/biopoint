...
circle_data = pd.read_csv("nsi_csi_circle.csv")
...
square_data = pd.read_csv("nsi_csi_square.csv")
...
triangle_data = pd.read_csv("nsi_csi_triangle.csv")
...
rect_1_3_data = pd.read_csv("nsi_csi_rect_1_3.csv")
...
rect_1_7_data = pd.read_csv("nsi_csi_rect_1_7.csv")
...
rect_1_19_data = pd.read_csv("nsi_csi_rect_1_19.csv")
...
df.to_csv('csi_nsi_1_5.csv', index = False)
plt.figure(2)
