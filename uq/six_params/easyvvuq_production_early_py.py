...
actions = Actions(CreateRunDirectory('/home/chattaraj_s/vvuq/np_1000/cell_height_9/six_params/tmp', flatten=True),
                  Encode(encoder), execute, Decode(decoder))
target_dir = '/home/chattaraj_s/vvuq/np_1000/cell_height_9/six_params/tmp'
if not os.path.exists(target_dir):
                    os.mkdir(target_dir)
campaign = uq.Campaign(name='sem', params=params, actions=actions, work_dir='/home/chattaraj_s/vvuq/np_1000/cell_height_9/six_params/tmp')
